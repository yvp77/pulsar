...
# pip install json
#
# Скрипт для удаленного снятия показаний со счетчиков Пульсар-16М
# запуск ./pulsar_m.py /dev/ttyUSB0 <скорость_порта> <адрес_счетчика>
# <скорость_порта> - 9600,19200, и т.д.
# <адрес_счетчика> номер прибора, серийный номер
#
# Примеры linux:
